...
**Endpoint:** `GET https://app-chfyozakqsqp-api-Xa6JZq205MNa.gateway.appmedo.com/v1/entity/search`
...
async function searchEntities(params: EntitySearchParams = {}): Promise<EntitySearchResponse> {
  ...
  const response = await fetch(
    `https://app-chfyozakqsqp-api-Xa6JZq205MNa.gateway.appmedo.com/v1/entity/search?${query.toString()}`,
